...
Public Class FrmSQLInstalacion
    ...
    Private Sub BtDescargarSQL_Click(sender As Object, e As EventArgs) Handles BtDescargarSQL.Click
        ...
        Shell("cmd.exe /c " & rutadescargas & "unrar.exe x -u -y " & rutadescargas & "SQL\SQLServer2014.iso " & rutadescargas & "SQL\", AppWinStyle.NormalFocus, True)
        ...
        Try
            Process.Start(rutadescargas & "SQL\Setup.exe", parametrossql)
